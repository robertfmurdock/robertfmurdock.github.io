...
I've brushed up on some concepts here I shouldn't dig into further in this piece - I know you're all thinking "how can you get good quality without those hand-offs?" - but for now, allow me to refer you to my old piece *[Discipline Fusion Assessment](https://robertfmurdock.github.io/DisciplineFusionAssessment.html)*. It doesn't have all the answers, but should give you a clue as to my line-of-thought on these questions.
